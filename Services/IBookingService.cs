...
namespace Codeline_HealthCareCenter_OOP.Services
{
    public interface IBookingService
    {
        public interface IBookingService
        {
            ...
            void CancelAppointment(BookingInputDTO input, int patientId);
            void DeleteAppointments(BookingInputDTO input);
            ...
            IEnumerable<Booking> ScheduledAppointments(int clinicId, DateTime date);
